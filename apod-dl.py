...
consumption by other scripts. APOD will be downloaded to Pictures/apod folder 
in user's home directory, preserving the original file name.
"""
...
def get_image_url():
    """ Return the url of the full-sized APOD image. """
